...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('valuation', ['Family'])
        ...
        db.send_create_signal('valuation', ['FamilyMember'])
        ...
        db.send_create_signal('valuation', ['Class'])
        ...
        db.send_create_signal('valuation', ['StudentClass'])
        ...
        db.create_table(u'valuation_attendance', (
            ...
            ('date', self.gf('django.db.models.fields.CharField')(default='2014-08-29', max_length=11)),
        ))
        db.send_create_signal('valuation', ['Attendance'])
        ...
        db.send_create_signal('valuation', ['Event'])
        ...
        db.send_create_signal('valuation', ['EventData'])
    ...
    models = {
        'valuation.attendance': {
            ...
            'classname': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.Class']"}),
            'date': ('django.db.models.fields.CharField', [], {'default': "'2014-08-29'", 'max_length': '11'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.FamilyMember']"})
        },
        'valuation.class': {
        ...
        'valuation.eventdata': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'default': "'2014-08-29'", 'max_length': '11'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.Event']"}),
            'family': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.Family']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'valuation.family': {
        ...
        'valuation.studentclass': {
            'Meta': {'object_name': 'StudentClass'},
            'classname': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.Class']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['valuation.FamilyMember']", 'null': 'True', 'blank': 'True'})
        }
    }
